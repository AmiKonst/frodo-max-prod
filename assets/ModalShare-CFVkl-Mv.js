import { aQ as getDefaultExportFromCjs, _ as _export_sfc, u as useI18n, r as reactive, s as stores, o as onMounted, b as createBlock, f as openBlock, k as withCtx, c as createElementBlock, d as createCommentVNode, l as createBaseVNode, e as createVNode, I as IconButton, h as unref, M as BaseModal, N as copyText, O as message } from './index-a9O3lNGh.js';
...
onMounted(() => {
    const payload = modals.getData('share');

    data.url = payload?.url;
    data.message = payload?.message;
    data.description = payload?.description;
    data.title = locale.title(payload?.title);
    data.copied = payload?.copied;
      ...
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("div", _hoisted_4, [
          createVNode(IconButton, {
            title: unref(t)('modals.share.share'),
            class: "invert secondary size-l",
            icon: "share",
            onClick: share
          }, null, 8, ["title"]),
          createVNode(IconButton, {
            title: unref(t)('modals.share.copy'),
            class: "invert secondary size-l",
            icon: "copy",
            onClick: copy
          }, null, 8, ["title"])
...
const ModalShare = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4027cf2a"]]);

export { ModalShare as default };
//# sourceMappingURL=ModalShare-CFVkl-Mv.js.map
