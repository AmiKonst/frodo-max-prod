import { _ as _export_sfc, u as useI18n, g as api, s as stores, r as reactive, j as computed, o as onMounted, a as onBeforeUnmount, b as createBlock, f as openBlock, k as withCtx, d as createCommentVNode, c as createElementBlock, e as createVNode, p as normalizeClass, I as IconButton, F as Fragment, v as toDisplayString, h as unref, A as AudioToggle, q as Img } from './index-h-b34pYs.js';
import { I as ItemDetail } from './ItemDetail-DKnk5EJC.js';
import { _ as _sfc_main$1 } from './Tracks-BCOm2Abg.js';
import { _ as _sfc_main$2 } from './Donate-CVrrBuBH.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const playAndShuffle = async () => {
        ...
        player.dict.play(data.item.code, props.type.code, { shuffle: true });
        return;
    };
    ...
    toolbar: withCtx(() => [
      (data.tone)
        ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createVNode(_sfc_main$2, { dunk: true }),
            createVNode(IconButton, {
              icon: "apps",
...
const Dictionary = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-f8aba732"]]);

export { Dictionary as D };
//# sourceMappingURL=Dictionary-D474RO4y.js.map
