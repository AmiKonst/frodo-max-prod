import { _ as _export_sfc, u as useI18n, s as stores, r as reactive, j as computed, o as onMounted, g as api, t as resolveComponent, b as createBlock, f as openBlock, k as withCtx, l as createBaseVNode, c as createElementBlock, d as createCommentVNode, e as createVNode, I as IconButton, A as AudioToggle, p as normalizeClass, h as unref, n as _sfc_main$1, T as TrackWave, v as toDisplayString, F as Fragment, m as renderList, q as Img, L as BaseModal, N as message } from './index-bBOtgSLi.js';
...
const hasQueue = computed(() => {
    ...
    return player.panes.default.hasQueue;
});
...
const inQueue = computed(() => {
    ...
    return player.panes.default.inQueue(data.item?.id);
});
...
const isNext = computed(() => {
    ...
    return player.panes.default.isNext(data.item?.id);
});
...
const addToQueue = () => {
    player.addToQueue(data.item);

    message.info(t('modals.track-kebab.added-to-queue'));
};

const playNext = () => {
    player.playNext(data.item);
    
    message.info(t('modals.track-kebab.added-to-queue'));
};

const removeFromQueue = () => {
    player.removeFromQueue(data.item?.id);
};
  ...
  return (openBlock(), createBlock(BaseModal, {
    ...
    content: withCtx(() => [
      createBaseVNode("ul", _hoisted_2, [
        ...
        (hasQueue.value && !inQueue.value && !state.value)
          ? (openBlock(), createElementBlock("li", {
              key: 1,
              class: "clickable",
              onClick: addToQueue
            }, [
              createVNode(_component_Icon, { icon: "add-to-queue" }),
              createBaseVNode("span", null, toDisplayString(unref(t)('modals.track-kebab.add-to-queue')), 1)
            ]))
          : createCommentVNode("", true),
        (hasQueue.value && inQueue.value && !state.value)
          ? (openBlock(), createElementBlock("li", {
              ...
              createBaseVNode("span", null, toDisplayString(unref(t)('modals.track-kebab.remove-from-queue')), 1)
            ]))
          : createCommentVNode("", true),
        (hasQueue.value && !state.value && unref(player).panes.default?._item?.id && !isNext.value)
          ? (openBlock(), createElementBlock("li", {
              key: 3,
              class: "clickable",
              onClick: playNext
            }, [
              createVNode(_component_Icon, { icon: "play-next" }),
              createBaseVNode("span", null, toDisplayString(unref(t)('modals.track-kebab.play-next')), 1)
            ]))
          : createCommentVNode("", true),
        (!locked.value)
          ? (openBlock(), createElementBlock("li", {
        ...
        (data.releases?.length)
          ? (openBlock(true), createElementBlock(Fragment, { key: 6 }, renderList(data.releases, (item) => {
        ...
        (contributors.value?.length)
          ? (openBlock(true), createElementBlock(Fragment, { key: 7 }, renderList(contributors.value, (item) => {
              return (openBlock(), createElementBlock("li", {
                key: item.id,
                class: "clickable",
...
const ModalTrackKebab = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-33b3ecac"]]);

export { ModalTrackKebab as default };
//# sourceMappingURL=ModalTrackKebab-B_YAKTOW.js.map
